...
def parse_args():
    ...
    parser.add_argument('--devkit_path',default='./data/voc2007/VOCdevkit/',help='pascal voc devkit path')  # voc根路径 里面存放的是VOC2007和VOC2012两个子文件夹
...
def main():
    ...
    if year == '2007':
        prefix = 'voc07'
        split = ['train', 'val', 'test']  # train集和test集
    elif year == '2012':
        prefix = 'voc12'
...
if __name__ == '__main__':
    main()
    print(tuple(PRE_DEFINE_CATEGORIES.keys()))
